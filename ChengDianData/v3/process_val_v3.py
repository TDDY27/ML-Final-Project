...
for t in range(int(sys.argv[1]),int(sys.argv[2])):
    ...
    data.to_csv("./datav3_t{}/raw_vdata_full_column.csv".format(t), index=False)
    val.to_csv("./datav3_t{}/raw_val_full_column.csv".format(t), index=False)

    for c in nc_val.columns:
        nc_data[c] = nc_data[c].fillna(nc_data[c].mean())
        nc_val[c] = nc_val[c].fillna(nc_val[c].mean())
    nc_data.to_csv("./datav3_t{}/raw_vdata.csv".format(t), index=False)
    nc_val.to_csv("./datav3_t{}/raw_val.csv".format(t), index=False)
    ...
    data.to_csv("./datav3_t{}/norm_vdata_full_column.csv".format(t), index=False)
    val.to_csv("./datav3_t{}/norm_val_full_column.csv".format(t), index=False)
    std_data.to_csv("./datav3_t{}/std_vdata_full_column.csv".format(t), index=False)
    std_val.to_csv("./datav3_t{}/std_val_full_column.csv".format(t), index=False)
    ...
    nc_data.to_csv("./datav3_t{}/norm_vdata.csv".format(t), index=False)
    nc_val.to_csv("./datav3_t{}/norm_val.csv".format(t), index=False)
    nc_std_data.to_csv("./datav3_t{}/std_vdata.csv".format(t), index=False)
    nc_std_val.to_csv("./datav3_t{}/std_val.csv".format(t), index=False)