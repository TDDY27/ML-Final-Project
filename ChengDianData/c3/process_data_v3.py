...
for t in range(int(sys.argv[1]),int(sys.argv[2])):
    ...
    test1.to_csv("./datac3_t{}/raw_test1_full_column.csv".format(t), index=False)
    test2.to_csv("./datac3_t{}/raw_test2_full_column.csv".format(t), index=False)
    ...
    nc_test1.to_csv("./datac3_t{}/raw_test1.csv".format(t), index=False)
    nc_test2.to_csv("./datac3_t{}/raw_test2.csv".format(t), index=False)
    ...
    test1.to_csv("./datac3_t{}/norm_test1_full_column.csv".format(t), index=False)
    test2.to_csv("./datac3_t{}/norm_test2_full_column.csv".format(t), index=False)
    std_data.to_csv("./datac3_t{}/std_data_full_column.csv".format(t), index=False)
    std_test1.to_csv("./datac3_t{}/std_test1_full_column.csv".format(t), index=False)
    std_test2.to_csv("./datac3_t{}/std_test2_full_column.csv".format(t), index=False)
    ...
    for c in nc_std_test1.columns:
        if c not in ['home_team_win']:
            ...
            nc_std_test1[2] = (nc_std_test2[c] - nc_std_data[c].mean()) / nc_std_data[c].std()
    ...
    nc_test1.to_csv("./datac3_t{}/norm_test1.csv".format(t), index=False)
    nc_test2.to_csv("./datac3_t{}/norm_test2.csv".format(t), index=False)
    nc_std_data.to_csv("./datac3_t{}/std_data.csv".format(t), index=False)
    nc_std_test1.to_csv("./datac3_t{}/std_test1.csv".format(t), index=False)
    nc_std_test1.to_csv("./datac3_t{}/std_test2.csv".format(t), index=False)