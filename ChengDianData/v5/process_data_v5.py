...
for t in range(int(sys.argv[1]),int(sys.argv[2])):
    ...
    data.to_csv("./datav5_t{}/raw_data_full_column.csv".format(t), index=False)
    test1.to_csv("./datav5_t{}/raw_test1_full_column.csv".format(t), index=False)
    test2.to_csv("./datav5_t{}/raw_test2_full_column.csv".format(t), index=False)
    ...
    data.to_csv("./datav5_t{}/norm_data_full_column.csv".format(t), index=False)
    test1.to_csv("./datav5_t{}/norm_test1_full_column.csv".format(t), index=False)
    test2.to_csv("./datav5_t{}/norm_test2_full_column.csv".format(t), index=False)
    std_data.to_csv("./datav5_t{}/std_data_full_column.csv".format(t), index=False)
    std_test1.to_csv("./datav5_t{}/std_test1_full_column.csv".format(t), index=False)
    std_test2.to_csv("./datav5_t{}/std_test2_full_column.csv".format(t), index=False)