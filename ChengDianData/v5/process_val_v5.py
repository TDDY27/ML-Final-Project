...
for t in range(int(sys.argv[1]),int(sys.argv[2])):
    ...
    data.to_csv("./datav5_t{}/raw_vdata_full_column.csv".format(t), index=False)
    val.to_csv("./datav5_t{}/raw_val_full_column.csv".format(t), index=False)
    ...
    data.to_csv("./datav5_t{}/norm_vdata_full_column.csv".format(t), index=False)
    val.to_csv("./datav5_t{}/norm_val_full_column.csv".format(t), index=False)
    std_data.to_csv("./datav5_t{}/std_vdata_full_column.csv".format(t), index=False)
    std_val.to_csv("./datav5_t{}/std_val_full_column.csv".format(t), index=False)